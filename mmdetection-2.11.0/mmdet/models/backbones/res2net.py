    ...
    def __init__(
        ...
        **kwargs
        ...
        self.conv3 = build_conv_layer(
            self.conv_cfg, width * scales, self.planes * self.expansion, kernel_size=1, bias=False
        )
...
class Res2Net(ResNet):
    ...
    def __init__(
        self, scales=4, base_width=26, style="pytorch", deep_stem=True, avg_down=True, **kwargs
    ):
        self.scales = scales
        self.base_width = base_width
        super(Res2Net, self).__init__(style="pytorch", deep_stem=True, avg_down=True, **kwargs)
