...
class SABLHead(nn.Module):
    ...
    def __init__(
        ...
        self.cls_fcs = self._add_fc_branch(
            self.num_cls_fcs, self.cls_in_channels, self.roi_feat_size, self.cls_out_channels
        )
    ...
    def get_bboxes(
        ...
        if cfg is None:
            ...
            det_bboxes, det_labels = multiclass_nms(
                bboxes, scores, cfg.score_thr, cfg.nms, cfg.max_per_img, score_factors=confids
            )
