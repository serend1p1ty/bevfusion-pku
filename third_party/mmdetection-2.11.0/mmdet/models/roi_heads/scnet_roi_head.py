...
class SCNetRoIHead(CascadeRoIHead):
    ...
    def forward_train(
        ...
        mask_results = self._mask_forward_train(
            x, sampling_results, gt_masks, rcnn_train_cfg, semantic_feat, glbctx_feat, relayed_feat
        )
    ...
    def simple_test(self, x, proposal_list, img_metas, rescale=False):
        ...
        for i in range(self.num_stages):
            ...
            bbox_results = self._bbox_forward(
                i, x, rois, semantic_feat=semantic_feat, glbctx_feat=glbctx_feat
            )
        ...
        if self.with_mask:
            if all(det_bbox.shape[0] == 0 for det_bbox in det_bboxes):
                ...
                bbox_results = self._bbox_forward(
                    -1, x, mask_rois, semantic_feat=semantic_feat, glbctx_feat=glbctx_feat
                )
