...
def parse_args():
    ...
    parser.add_argument(
        "--nn-module", action="store_true", help="to train models related to neural network modules"
    )
    parser.add_argument(
...
benchmark_pool = [
    ...
    "configs/cornernet/" "cornernet_hourglass104_mstest_8x6_210e_coco.py",  # special
