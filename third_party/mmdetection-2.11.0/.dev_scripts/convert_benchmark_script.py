...
def parse_args():
    ...
    parser.add_argument("json_path", type=str, help="json path output by benchmark_filter")
    parser.add_argument("partition", type=str, help="slurm partition name")
    parser.add_argument(
        "--max-keep-ckpts", type=int, default=1, help="The maximum checkpoints to keep"
    )
