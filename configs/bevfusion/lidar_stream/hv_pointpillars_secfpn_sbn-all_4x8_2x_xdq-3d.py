_base_ = [
    "../../_base_/models/hv_pointpillars_fpn_xdq.py",
    "../../_base_/datasets/xdq-3d.py",
...
model = dict(
    ...
    pts_bbox_head=dict(
        ...
        anchor_generator=dict(
            ...
            ranges=[
                [-160.0, -160.0, -1.800327, 160.0, 160.0, -1.800327],
                [-160.0, -160.0, -1.744403, 160.0, 160.0, -1.744403],
                [-160.0, -160.0, -1.685265, 160.0, 160.0, -1.685265],
                [-160.0, -160.0, -1.673391, 160.0, 160.0, -1.673391],
                [-160.0, -160.0, -1.617850, 160.0, 160.0, -1.617850],
                [-160.0, -160.0, -1.809849, 160.0, 160.0, -1.809849],
